...
class Inquiries implements Site {
    
    private ?array $data=[];
    private ?string $execute='setData';
    private ?array $prefix=[
        'pl'=>[
            'prefix'=>'/inquiriesadmin/view?id='
            ,'column'=>'id'
            ],
        ];
    private ?object $db;
    ...
    private function setData(){
        ...
        $result = $this->db->query("SELECT p.id FROM plasticonapp_inquiries as p WHERE 1 ORDER BY p.id ASC",MYSQLI_USE_RESULT);
